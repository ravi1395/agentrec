...
What `undo` does flag is the turn as a whole. Previewing any rich turn it did not itself record
prints a CAUTION that the turn's file list is an activity window rather than an authorship
